"""
Django settings for zoro_46813 project.
...
WSGI_APPLICATION = 'zoro_46813.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "zoro_46813 API",
    "DESCRIPTION": "API documentation for zoro_46813 App",
    "VERSION": "v1",
}
